        ...
        function setdata(){
            ...
            document.getElementById('fathername').innerHTML = "Знание иностранных языков<span style='margin-left:10px'></span>"+ ":" + document.getElementById('fname').value;
            document.getElementById('mothername').innerHTML = "Водительсикие права<span style='margin-left:10px'></span>"+":" + document.getElementById('mname').value;
            document.getElementById('permanentaddress').innerHTML = "Адрес Проживания<span style='margin-left:10px'></span>"+":"+ document.getElementById('paddress').value;
        ...
        function addcourse(){
            ...
            else if(document.getElementById('year').value == "" || (document.getElementById('year').value) < 1900 || (document.getElementById('year').value) > 2100 ){
